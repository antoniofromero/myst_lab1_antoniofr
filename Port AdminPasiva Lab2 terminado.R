...
##Port1<- weight_sum_constraint(type = "weight_sum", min_sum = 0.99, max_sum = 1.01)
#type = "fullinvestment" es cuando quieres invertir todo el capital, en otras palabras la suma de los pesos es 1
...
# Portafolio con maximo Sharpe ratio 
...
##CONCLUSIONES
#Después de elegir tres activos de diferentes sectores, esto cómo forma de diversificar el riesgo, 
#se hizo su análisis de datos para posteriormente crear  portafolios que reflejasen 
#el posible comportamiento en el futuro próximo. Esto para poder elegir un portafolio que cumplan las necesidades 
#ya sea de un cliente o personalmente 

#Se crearon 10,000 portafolios de inversión considerando 3 activos, Disney, Goldman Sachs y Pfizer 
#las restricciones del portafolio consideran que se invertirá todo el capital disponible, tomando como
#mínimo el 10% y el máximo el 70%, esto para invertir el mayor capital posible. EL resultado de los portafolios 
# es el consiguiente: el portafolio con el mínimo riesgo da un rendimiento del 4.38% con un riesgo del 12.87%
#mientras que el portafolio con el máximo sharpe ratio da un rendimiento del 12.9% con un riesfo del 14.4%.
#En este caso cómo vemos el portafolio que más conviene es el que tiene el máximo sharpe ratio ya que el 
#rendimiento es mayor y el riesgo no es considerablemente mucho en comparación con el que tiene menor varianza